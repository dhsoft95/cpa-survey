...
{{--            <p class="text-sm text-gray-500 mt-2">The submission of the questionnaire serves as a form of implied consent.</p>--}}
            ...
            <div class="mt-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                ...
                <p class="mt-4 text-sm text-gray-600 text-center max-w-md mx-auto leading-relaxed">
                    ✨ Keep this code safe! On April 21, 2025, check the awards section at the beginning of the survey and follow instructions to claim your gift card if you're a winner.
                </p>
            </div>
        </div>
...
to read the following and give us your consent</p>
                            <div class="prose prose-blue max-w-none text-gray-700">
                                ...
                                <p class="mb-4">
                                    Furthermore, upon submission of the survey, you will be issued with an autogenerated number. Please keep this number. On <strong style="color: black;">April 21, 2025 (and monthly thereafter until the survey is closed)</strong>, winning numbers will be drawn and published with instructions on how to claim your gift certificate. This survey is not collecting self identifying information, the onus will be on you to follow the instructions to claim your prize.
                                </p>
                                <p class="mb-4">
