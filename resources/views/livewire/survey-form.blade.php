...
to read the following and give us your consent</p>
                            <div class="prose prose-blue max-w-none text-gray-700">
                                ...
                                <p class="mb-4">
                                    Furthermore, upon submission of the survey, you will be issued with an autogenerated number. Please keep this number, on April 21, 2025,awards. This date is on the consent form and after
                                    submitting and they get the EI score.
                                </p>
                                <p class="mb-4">
