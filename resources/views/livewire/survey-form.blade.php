<div class="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-xl rounded-2xl p-8 text-center transform transition-all duration-300 hover:shadow-2xl">
            ...
            <div class="mt-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                ...
                <p class="mt-4 text-sm text-gray-600 text-center max-w-md mx-auto leading-relaxed">
                    ✨ Keep this code safe! Periodically check the awards section at the beginning of the survey and follow instructions to claim your gift card if you're a winner.
                </p>
            </div>
        </div>
    ...
    @elseif($showNonCpaThanks)
        ...
        <div class="bg-white shadow-xl rounded-2xl p-8 text-center transform transition-all duration-300 hover:shadow-2xl">
            ...
            <h2 class="mt-4 text-3xl font-bold text-gray-900 font-serif">Thank You!</h2>
            <p class="mt-2 text-lg text-gray-600">This survey is only for accountants in Canada.</p>
                ...
                <form wire:submit.prevent="nextStep">
                        ...
                        <div id="step-3-container" class="bg-white rounded-xl border border-blue-100 shadow-lg p-6 space-y-8 max-w-4xl mx-auto" x-init="window.scrollTo({top: 0, behavior: 'smooth'})">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-2">
                                ...
                                <div class="md:col-span-2 space-y-2">
                                    ...
                                    <input
                                        type="number"
                                        wire:model="demographicData.accounting_experience_years"
                    ...
                    @elseif($currentStep == 5)
                        <div class="space-y-6 mt-4">
                            ...
                            <div class="bg-blue-50 rounded-xl p-6 border border-blue-100">
                                <div class="mt-6">
                                    <h2 class="text-xl font-bold text-gray-800 mb-3">Confidential EI Assessment</h2>
                                    <p class="text-gray-700 mb-4">
                                        This section assesses your work-related EI behaviours using the Genos Emotional Intelligent Instrument. Upon submission of your completed survey you will get your personalized confidential EI score and profile. Although this is for research purposes only, your EI profile provides insights about strengths and areas to develop. Keep your score, at the end of the study, summary results will be shared to give you the opportunity to assess your score relative to those of your peers. <strong>Because your time and your career is important, this comprehensive EI assessment tool has been chosen because of its validated greater reliability and predictive validity, giving you an EI profile that will provide you meaningful insights.</strong>
                                        The section and questions are replicated from the Genos EI self-assessment Instrument, Copyright © Genos 2014.
                                    </p>
                                    <p class="text-gray-700 mb-4">
