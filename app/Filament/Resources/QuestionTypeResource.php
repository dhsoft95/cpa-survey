        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('slug')
                    ->required()
                    ->maxLength(255)
                    ->unique(QuestionType::class, 'slug', ignoreRecord: true),
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ->visible(fn (QuestionType $record) => $record->questions()->count() === 0),
            ])
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ->visible(fn () => auth()->user()->can('delete', QuestionType::class)),
                ]),
            ]);
    }
